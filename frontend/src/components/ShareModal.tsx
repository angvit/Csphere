    ...
    switch (platform) {
      case 'gmail':
        window.open(`https://mail.google.com/mail/?view=cm&fs=1&su=${encodeURIComponent(
          'Check out this bookmark from CSphere')}&body=${encodeURIComponent('I bookmarked this on CSphere: ' + bookmarkUrl)}`, '_blank');
        break;
      default:
      ...
      <div className="bg-white rounded-lg p-6 w-80">
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <button
              ...
              />
              <span className="whitespace-nowrap">Slack<br />(coming)</span>
            </button>
            ...
            <button
              ...
              <img
                ...
                className="w-8 h-8 mb-1.5"
              />
              <span className="whitespace-nowrap">Instagram<br />(coming) </span>
            </button>
